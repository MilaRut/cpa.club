...
/*!*****************************!*\
  !*** ./js/modules/timer.js ***!
  \*****************************/
/*! exports provided: initTimer */function(e,t,s){"use strict";s.r(t),s.d(t,"initTimer",(function(){return c}));var n=document.querySelector(".days-num"),r=document.querySelector(".hours-num"),a=document.querySelector(".minutes-num"),i=document.querySelector(".days-txt"),o=document.querySelector(".hours-txt"),l=document.querySelector(".minutes-txt"),d=new Date(2023,0,20,0,0);var c=function e(){!function(){var e=new Date,t=d-e,s=Math.floor(t/1e3/60/60/24),c=Math.floor(t/1e3/60/60)%24,u=Math.floor(t/1e3/60)%60;n.innerText=s<10?"0".concat(s):s,r.innerText=c<10?"0".concat(c):c,a.innerText=u<10?"0".concat(u):u;var p={1:"день",2:"дня",3:"дней"},f={1:"час",2:"часа",3:"часов"},m={1:"минута",2:"минуты",3:"минут"},h=String(s).slice(-1);1===parseInt(h,10)&&(parseInt(s,10)<10||parseInt(s,10)>20)?i.innerText=p[1]:2!==parseInt(h,10)&&3!==parseInt(h,10)&&4!==parseInt(h,10)||!(parseInt(s,10)<10||parseInt(s,10)>20)?i.innerText=p[3]:i.innerText=p[2];var g=String(c).slice(-1);1===parseInt(g,10)&&(parseInt(c,10)<10||parseInt(c,10)>20)?o.innerText=f[1]:2!==parseInt(g,10)&&3!==parseInt(g,10)&&4!==parseInt(g,10)||!(parseInt(c,10)<10||parseInt(c,10)>20)?o.innerText=f[3]:o.innerText=f[2];var v=String(u).slice(-1);1===parseInt(v,10)&&(parseInt(u,10)<10||parseInt(u,10)>20)?l.innerText=m[1]:2!==parseInt(v,10)&&3!==parseInt(v,10)&&4!==parseInt(v,10)||!(parseInt(u,10)<10||parseInt(u,10)>20)?l.innerText=m[3]:l.innerText=m[2]}(),setTimeout(e,3e3)}},"./js/modules/video.js":
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
