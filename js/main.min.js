...
/* harmony import */ var _modules_show_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/show-button */ "./js/modules/show-button.js");
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");
/* harmony import */ var _modules_photo_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/photo-slider */ "./js/modules/photo-slider.js");
/* harmony import */ var _modules_program_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/program-slider */ "./js/modules/program-slider.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/popup */ "./js/modules/popup.js");
/* harmony import */ var _modules_form_popup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/form-popup */ "./js/modules/form-popup.js");
/* harmony import */ var _modules_custom_popup__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/custom-popup */ "./js/modules/custom-popup.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/timer */ "./js/modules/timer.js");
/* harmony import */ var _modules_submit_success__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/submit-success */ "./js/modules/submit-success.js");
/* harmony import */ var _modules_effects__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/effects */ "./js/modules/effects.js");
/* harmony import */ var _modules_parallax__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/parallax */ "./js/modules/parallax.js");
/* harmony import */ var _modules_popup_loader__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/popup-loader */ "./js/modules/popup-loader.js");
/* harmony import */ var _modules_subscribe_popup__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/subscribe-popup */ "./js/modules/subscribe-popup.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["openMenu"])();
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["closeMenu"])();
  Object(_modules_effects__WEBPACK_IMPORTED_MODULE_12__["initEffects"])();
  Object(_modules_show_button__WEBPACK_IMPORTED_MODULE_3__["showButton"])();
  ...
  window.addEventListener('load', function () {
    Object(_modules_show_button__WEBPACK_IMPORTED_MODULE_3__["moveButton"])();
    Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_1__["initPreloader"])();
    Object(_modules_subscribe_popup__WEBPACK_IMPORTED_MODULE_15__["closeSubscribePopup"])();
    Object(_modules_video__WEBPACK_IMPORTED_MODULE_4__["setupVideo"])();
    Object(_modules_photo_slider__WEBPACK_IMPORTED_MODULE_5__["initPhotoSlider"])();
    Object(_modules_program_slider__WEBPACK_IMPORTED_MODULE_6__["initSwiper"])(swiper);
    Object(_modules_popup__WEBPACK_IMPORTED_MODULE_7__["initPopup"])();
    Object(_modules_form_popup__WEBPACK_IMPORTED_MODULE_8__["initFormPopup"])();
    Object(_modules_custom_popup__WEBPACK_IMPORTED_MODULE_9__["closeMerchantPopup"])();
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_10__["initTimer"])();
    Object(_modules_submit_success__WEBPACK_IMPORTED_MODULE_11__["showSuccessMsg"])();
    Object(_modules_parallax__WEBPACK_IMPORTED_MODULE_13__["initParallax"])();
    Object(_modules_parallax__WEBPACK_IMPORTED_MODULE_13__["updateMousemoves"])();
    Object(_modules_popup_loader__WEBPACK_IMPORTED_MODULE_14__["initPopupLoader"])();
  });
});
...
/*!************************************!*\
  !*** ./js/modules/custom-popup.js ***!
  \************************************/
/*! exports provided: closeMerchantPopup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeMerchantPopup", function() { return closeMerchantPopup; });
var customPopupOverlay = document.querySelector('.custom-popup__bg');
var customPopup = document.querySelector('.custom-popup');
var closeBtn = document.querySelector('.custom-popup__close-btn');
...
/*!*******************************!*\
  !*** ./js/modules/effects.js ***!
  \*******************************/
/*! exports provided: initEffects */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initEffects", function() { return initEffects; });
function initEffects() {
  var paragraphs = document.querySelectorAll('.paragraph-transition');
  var headings = document.querySelectorAll('.heading-scale');
  var timerShadow = document.querySelector('.timer-shadow');
...
/*!**********************************!*\
  !*** ./js/modules/form-popup.js ***!
  \**********************************/
/*! exports provided: initFormPopup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormPopup", function() { return initFormPopup; });
var formOverlay = document.querySelector('.form-popup__bg');
var formPopup = document.querySelector('.form-popup');
var openBtns = document.querySelectorAll('.open-form-popup');
var closeBtn = document.querySelector('.form-popup__close-btn');
var formPopupItems = document.querySelectorAll('.form-popup__item');
...
function initFormPopup() {
  openBtns.forEach(function (button) {
    ...
    var itemId = currentBtn.getAttribute('data-value');
    var currentItem = formPopup.querySelector(itemId);
...
var menuOpenBtn = document.querySelector('.header__menu-btn');
...
function closeMenu() {
  ...
  document.addEventListener('click', function (e) {
    ...
    var itsBtnMenu = target === menuOpenBtn;
    var navIsOpen = headerNav.classList.contains('header__nav--open');
...
/*!********************************!*\
  !*** ./js/modules/parallax.js ***!
  \********************************/
/*! exports provided: initParallax, updateMousemoves */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initParallax", function() { return initParallax; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateMousemoves", function() { return updateMousemoves; });
function initParallax() {
  var parallaxLayers = document.querySelectorAll('.parallax-layer');
  var speeds = [0.2, 0.2, 0.6, 0.8, 0.3, 0.5, 0.3, 0.2, 0.2];
  var diffs = [400, 200, 2500, 3200, 4200, 3400, 18000, 19500, 17000];
...
function updateMousemoves() {
  var mouseMoves = document.querySelectorAll('.mousemove');
  var index = [5, 8, 3, 7, 5];
  var _loop = function _loop(i) {
    var elem = mouseMoves[i];
...
/*!************************************!*\
  !*** ./js/modules/photo-slider.js ***!
  \************************************/
/*! exports provided: initPhotoSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPhotoSlider", function() { return initPhotoSlider; });
...
/*!************************************!*\
  !*** ./js/modules/popup-loader.js ***!
  \************************************/
/*! exports provided: initPopupLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPopupLoader", function() { return initPopupLoader; });
...
var openBtns = document.querySelectorAll('.open-popup');
var closeBtn = document.querySelector('.popup__close-btn');
var popupItems = document.querySelectorAll('.popup__item');
function resetClasses() {
...
function initPopup() {
  openBtns.forEach(function (button) {
    var currentBtn = button;
    var itemId = currentBtn.getAttribute('data-value');
    var currentItem = popup.querySelector(itemId);
    button.addEventListener('click', function (e) {
      e.preventDefault();
      currentItem.classList.add('active');
...
var initSwiper = function initSwiper(swiper) {
  if (swiper) {
    // eslint-disable-next-line
...
/***/ "./js/modules/show-button.js":
/*!***********************************!*\
  !*** ./js/modules/show-button.js ***!
  \***********************************/
/*! exports provided: showButton, moveButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showButton", function() { return showButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveButton", function() { return moveButton; });
var buyButton = document.querySelector('.buy-ticket-btn');
var ticketBanner = document.querySelector('.ticket-banner');
var bannerCloseBtn = document.querySelector('.ticket-banner__close-btn');
function showButton() {
...
var jivoContainer = document.querySelector('.globalClass_be5a');
var jivoPopup = document.querySelector('.popupBlock_a3a4');
var jivoChat = document.querySelector('.wrap_b8bd');
var bannerText = document.querySelector('.ticket-banner__text');

// setInterval(function () {
//   jivoChat.classList.remove('__show_e999');
//   jivoPopup.classList.remove('__show_be88');
// }, 5000);

// setInterval(function () {
//   jivoChat.classList.add('__show_e999');
//   jivoPopup.classList.remove('__show_be88');
// }, 8000);

// setInterval(function () {
//   jivoChat.classList.remove('__show_e999');
//   jivoPopup.classList.add('__show_be88');
// }, 11000);
...
/*!**************************************!*\
  !*** ./js/modules/submit-success.js ***!
  \**************************************/
/*! exports provided: showSuccessMsg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showSuccessMsg", function() { return showSuccessMsg; });
var submitBtn = document.querySelectorAll('.form__submit-btn');
var submitMsgOverlay = document.querySelector('.success-popup__bg');
var popup = document.querySelector('.success-popup');
var closeBtn = document.querySelector('.success-popup__close-btn');
var popupOverlays = document.querySelectorAll('.popup__bg');
var popups = document.querySelectorAll('.popup');
var popupItems = document.querySelectorAll('.popup__item');
var formPopupOverlays = document.querySelectorAll('.form-popup__bg');
var formPopups = document.querySelectorAll('.form-popup');
var formPopupItems = document.querySelectorAll('.form-popup__item');
function closeAllPopups() {
  ...
  formPopupOverlays.forEach(function (item) {
    item.classList.remove('active');
  });
  formPopups.forEach(function (item) {
    item.classList.remove('active');
  });
  formPopupItems.forEach(function (item) {
    item.classList.remove('active');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeSubscribePopup", function() { return closeSubscribePopup; });
var subscribeOverlay = document.querySelector('.subscribe-popup__bg');
var subscribePopup = document.querySelector('.subscribe-popup');
var closeBtn = document.querySelector('.subscribe-popup__close-btn');
function prepareClosingPopup() {
...
var daysNum = document.querySelector('.days-num');
var hoursNum = document.querySelector('.hours-num');
var minutesNum = document.querySelector('.minutes-num');
var daysTxt = document.querySelector('.days-txt');
var hoursTxt = document.querySelector('.hours-txt');
var minutesTxt = document.querySelector('.minutes-txt');
var day = Number(document.querySelector('#day').textContent);
var month = Number(document.querySelector('#month').textContent - 1);
var html = document.querySelector('html');
var date = new Date(2023, month, day, 0, 0);
function initCounts() {
  var now = new Date();
  var gap = date - now;
  ...
  daysNum.innerText = days < 10 ? "0".concat(days) : days;
  hoursNum.innerText = hours < 10 ? "0".concat(hours) : hours;
  minutesNum.innerText = minutes < 10 ? "0".concat(minutes) : minutes;
  var namesRu = {
    daysRu: {
      1: 'день',
      2: 'дня',
  ...
  var sliceDay = String(days).slice(-1);
  if (html.lang === 'ru') {
  ...
  var sliceHours = String(hours).slice(-1);
  if (html.lang === 'ru') {
  ...
  var sliceMinutes = String(minutes).slice(-1);
  if (html.lang === 'ru') {
